        ...
        public void execute(String command) {
            ...
            switch (head) {
                ...
                case "return-register": {
                    AppGUI.receiveRegisterResponse(body);
                    break;
                }
                case "return-log-in": {
                    ...
                    if (bodyMatcher.group(5).equals("Your account does not exist!") || bodyMatcher.group(5).equals("Your username or password is invalid!"))
                        AppGUI.receiveLoginResponse(bodyMatcher.group(5));
                    else gui.receiveLoginResponse(bodyMatcher.group(5));
                    break;
                }
                case "return-search": {
